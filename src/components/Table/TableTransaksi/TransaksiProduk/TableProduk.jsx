...
const TableProduk = ({ userDataEvent }) => {
          ...
          <Link to="/transaksi">
            <div>
              <button 
                id="btnevent"
                type="button" 
               className={`${styles.btnevent} btn btn-sm mt-4 body-medium-semibold me-4`}>
                Event
              </button>
              <img src={theater_comedy} className={styles.theater_comedy} alt=""/>
            </div>
          </Link>
                ...
                <tbody className={styles.tbody} id="tbody">
                  {currentItems.map((item, index) => (
                    <tr className={styles.tableRow} key={index}>
                      ...
                      <td className={`p-3 title-small-semibold ${item.status === "Sukses" ? styles.success : ""} 
