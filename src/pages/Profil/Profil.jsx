      ...
      <div className={styles.wrapper}>
         ...
         <div className={styles.judul}>
               ...
               <div className={styles.sideRight}>
                  ...
                  <p className="title-small-regular">Balink adalah brand aplikasi yang dibuat khusus traveling yang ada di pulau Dewata bali. Balink dibuat untuk memberikan kemudahan bagi para wisatawan nasional yang ingin mengunjungi Pulau Dewata Bali. Banyak yang bisa dilakukan oleh pengguna Balink sebagai tempat untuk melakukan reservasi tempat wisata, membaca artikel hinggal membeli suatu produk khas Bali. Balink menghadirkan inovaso terbaru dengan kemudahan sistem yang dapat di rasakan oleh pengguna saat menggunakan aplikasi Balink.</p>
               </div>
         </div>
         ...
         <div className={styles.parentInformasi}>
            <div className={styles.sideLeftInformasi}>
               <div className="email">
                  <p className={`body-large-regular ${styles.label}`}>Email Adress</p>
         ...
         <div className={styles.parentInformasi}>
            ...
            <div className={styles.sideRightInformasi}>
               <div className={styles.whatsapp}>
                  ...
                  <p className="body-large-regular">Kecamatan Kuta, Sebelah Selata Kota Denpasar, Bali</p>
               </div>
            </div>
         </div>
         </div>
         ...
         <div className={styles.parentInformasi}>
            <div className={styles.sideLeftInformasi}>
               <div className="email">
                  <p className={`body-large-regular ${styles.label}`}>Bank Central Asia(BCA)</p>
                  <p className="body-large-regular">3456 1234 6789</p>
               </div>
               <div className="phone">
                  <p className={`body-large-regular ${styles.label}`}>Bank Mandiri</p>
         ...
         <div className="d-flex w-100 justify-content-end mt-3">
            <Button label="Edit Profil" color="brown" icon={Edit} onClick={(()=> navigate("/profile/editProfil"))}/>
         </div>
     </div>
   )
}
