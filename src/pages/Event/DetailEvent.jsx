  ...
  return (
    <div className={`${styles.autoLayout}`}>
      ...
      <div className={`${styles.layoutDetail}`}>
        <p className="body-large-semibold" id="detail">
          Detail Event
        </p>
        <div className="d-flex">
          <div className="col-8">
            <div className="info-lengkap" id="infoLengkap">
              ...
              <span className={`body-medium-semibold ${styles.detailJudul}`}>
                Info Lengkap
              </span>
          ...
          <div className="col-4">
            <div id="lokasi">
              ...
              <p className={`body-medium-regular ${styles.detailIsi}`}>
                {detailEvent.loc}
              </p>
            </div>
            <div id="maps">
          ...
          <div className="col-11">
            ...
            {toggle ? (
              <div className={`${styles.isiTiket}`} id="tiketBayar">
                <div>
                  <span className="body-small-regular">
                    {detailEvent.titleHarga}
                  </span>
                  <br />
                  <span className="body-medium-regular">
                    {detailEvent.descHarga}
                  </span>
                </div>
                <div>
                  <span className="body-small-regular">
                    {detailEvent.titleJumlah}
                  </span>
                  <br />
                  <span className="body-medium-regular">
                    {detailEvent.descJumlah}
                  </span>
                </div>
              </div>
            ) : (
