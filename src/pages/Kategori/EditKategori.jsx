    ...
    <div>
      {loading ? (
        ...
        <div id="editKategoriContainer" className={styles.tambahEventContainer}>
          <h1 id="editKategoriTitle" className="headline-small-semibold">
            Edit Kategori
          </h1>
            ...
            <div className="mt-5">
              ...
              <div>
                <p className="body-small-regular">
                  Ketik nama promo maksimal 20 kata dengan kalimat yang menarik
                  agar Admin dapat dengan mudah memilih kategori berdasarkan
                  barang yg dibuat.
                </p>
                <Input
                  type={"text"}
            ...
            <div className="mt-5">
              ...
              <div>
                <p className="body-small-regular">
                  ...
                  membantu admin mengetahui kategori yang anda buat dipakai
                  untuk barang apa saja.
                </p>
